...
test("Test Rectangle", function() {
	...
	var r2 = new unb3nd.Rectangle(1, 2, 3, 4);
	...
	var pointInside = new unb3nd.unb3nd.Vector2();
	pointInside.x = 1;
	pointInside.y = 3;
	...
	var pointOutside = new unb3nd.unb3nd.Vector2();
	pointOutside.x = 0.5;
	pointOutside.y = 3;
...
test("Test unb3nd.Vector2", function() {
	var v1 = new unb3nd.unb3nd.Vector2();
	equal(v1.x, 0, "Initial x is zero");
	equal(v1.y, 0, "Initial y is zero");
	
	var v2 = new unb3nd.unb3nd.Vector2(1, 2);
	equal(v2.x, 1, "Initialized x correctly");
	equal(v2.y, 2, "Initialized y correctly");
	
	equal(unb3nd.unb3nd.Vector2.getAngle(new unb3nd.unb3nd.Vector2(1, 0), new unb3nd.unb3nd.Vector2(0, 1)), Math.PI / 2, "Angle determined correctly");
	deepEqual(v2, v2.clone(), "Clone returns deeply equal copy");
	
	var v3 = new unb3nd.unb3nd.Vector2(4, 5);
	var v4 = v3.add(v2);
...
test("Test Matrix2", function() {
	// test equal
	ok(new unb3nd.Matrix2(5, 6, 7, 8).equal(new unb3nd.Matrix2(5, 6, 7, 8)), "equal implementation positive check");
	ok(!new unb3nd.Matrix2(5, 6, 7, 8).equal(new unb3nd.Matrix2(5, 6, 7, 9)), "equal implementation negative check");
	
	// test get entry
	var m1 = new unb3nd.Matrix2(1, 2, 3, 4);
	...
	// vector
	var v1 = new unb3nd.unb3nd.Vector2(9, 12);
	...
	var m2 = new unb3nd.Matrix2(5, 6, 7, 8);
	var m1m2 = m1.mult(m2);
	...
	var m3 = new unb3nd.Matrix2(1, 2, 3, 4);
	var m4 = new unb3nd.Matrix2(5, 6, 7, 8);
	var m3m4 = m3.mult(m4);
	...
	ok(m3addm4.equal(m3addMm4), "Add mutate correct");
	
	// determinant
	equal(m3.getDeterminant(), 4 - 2 * 3, "Determinant correct");
	
	// identity matrix
	var i2 = unb3nd.Identity2.instance;
	...
	ok(m3.getInverse().mult(m3).equal(unb3nd.Identity2.instance), "Inverse commutative correct");
	ok(m3.mult(m3.getInverse()).equal(unb3nd.Identity2.instance), "Inverse commutative correct");
	
	// rotation matrix
	var TOL = 0.01;
  var mr = new unb3nd.RotationMatrix2(3 * Math.PI / 8);
	...
	var v2 = new unb3nd.unb3nd.Vector2(1.5, -0.75);
