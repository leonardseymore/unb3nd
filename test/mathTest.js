...
test("Test Rectangle", function() {
	...
	equals(r1.x, 0, "Default x is zero");
	equals(r1.y, 0, "Default y is zero");
	equals(r1.width, 0, "Default width is zero");
	equals(r1.height, 0, "Default height is zero");
	
	var r2 = new Rectangle(1, 2, 3, 4);
	equals(r2.x, 1, "x is initialized correctly");
	equals(r2.y, 2, "y is initialized correctly");
	equals(r2.width, 3, "width is initialized correctly");
	equals(r2.height, 4, "height is initialized correctly");
	...
	equals(r3.x, r2.x + shrinkAmount, "Shrink in x correct");
	equals(r3.y, r2.y + shrinkAmount, "Shrink in y correct");
	equals(r3.width, r2.width - shrinkAmount * 2, "Shrink in width correct");
	equals(r3.height, r2.height - shrinkAmount * 2, "Shrink in height correct");
...
test("Test Vector2", function() {
	var v1 = new Vector2();
	equals(v1.x, 0, "Initial x is zero");
	equals(v1.y, 0, "Initial y is zero");
	
	var v2 = new Vector2(1, 2);
	equals(v2.x, 1, "Initialized x correctly");
	equals(v2.y, 2, "Initialized y correctly");
	...
	equals(v4.x, v3.x + v2.x, "Add on x correct");
	equals(v4.y, v3.y + v2.y, "Add on y correct");
	
	var v5 = v3.clone();
	v5.addMutate(v2);
	deepEqual(v5, v4, "Add mutate deeply equals");
	
	var v6 = v3.sub(v2);
	ok(v6 !== v3, "Sub returns new object reference");
	equals(v6.x, v3.x - v2.x, "Sub on x correct");
	equals(v6.y, v3.y - v2.y, "Sub on y correct");
	...
	equals(v9.x, v3.x * scalar, "Mult scalar on x correct");
	equals(v9.y, v3.y * scalar, "Mult scalar on y correct");
	
	var v10 = v3.clone();
	v10.multScalarMutate(scalar);
	deepEqual(v10, v9, "Mult scalar mutate deeply equals");
	...
	equals(nv3.getMagnitude(), 1, "Normalized length is one");
	
	var nv4 = v3.clone();
	nv4.normalizeMutate();
	deepEqual(nv4, nv3, "Normalize mutate is deeply equals");
	
	var v11 = v3.clone();
	v11.zeroMutate();
	equals(v11.x, 0, "Zero mutate on x correct");
	equals(v11.y, 0, "Zero mutate on y correct");
});

test("Test Matrix2", function() {
	// test equals
	ok(new Matrix2(5, 6, 7, 8).equals(new Matrix2(5, 6, 7, 8)), "Equals implementation positive check");
	ok(!new Matrix2(5, 6, 7, 8).equals(new Matrix2(5, 6, 7, 9)), "Equals implementation negative check");
	
	// test get entry
	var m1 = new Matrix2(1, 2, 3, 4);
	equals(m1.getEntry(0, 0), 1, "Entry 1:1 correct");
	equals(m1.getEntry(0, 1), 2, "Entry 1:2 correct");
	equals(m1.getEntry(1, 0), 3, "Entry 2:1 correct");
	equals(m1.getEntry(1, 1), 4, "Entry 2:2 correct");
	
	// vector
	var v1 = new Vector2(9, 12);
	var m1v1 = m1.multVector(v1);
	equals(m1v1.x, m1.e[0] * v1.x + m1.e[1] * v1.y, "Vector x mutation correct");
	equals(m1v1.y, m1.e[2] * v1.x + m1.e[3] * v1.y, "Vector y mutation correct");
	...
	var m3m4 = m3.mult(m4);
	equals(m3m4.getEntry(0, 0), 19, "Entry 1:1 mult correct");
	equals(m3m4.getEntry(0, 1), 22, "Entry 1:2 mult correct");
	equals(m3m4.getEntry(1, 0), 43, "Entry 2:1 mult correct");
	equals(m3m4.getEntry(1, 1), 50, "Entry 2:2 mult correct");
	
	var m3addm4 = m3.add(m4);
	equals(m3addm4.getEntry(0, 0), 6, "Entry 1:1 add correct");
	equals(m3addm4.getEntry(0, 1), 8, "Entry 1:2 add correct");
	equals(m3addm4.getEntry(1, 0), 10, "Entry 2:1 add correct");
	equals(m3addm4.getEntry(1, 1), 12, "Entry 2:2 add correct");
	...
	// determinant
	equals(m3.getDeterminant(), 1 * 4 - 2 * 3, "Determinant correct");
	
	// identity matrix
	var i2 = Identity2.instance;
	equals(i2.getEntry(0, 0), 1, "Identity 1:1 correct");
	equals(i2.getEntry(0, 1), 0, "Identity 1:2 correct");
	equals(i2.getEntry(1, 0), 0, "Identity 2:1 correct");
	equals(i2.getEntry(1, 1), 1, "Identity 2:2 correct");
